...
public class BluetoothLeService extends Service {
    ...
    public final static UUID UUID_BODY_TEMP_MEASUREMENT =
            UUID.fromString(SampleGattAttributes.BODY_TEMP_MEASUREMENT);
    ...
    private void broadcastUpdate(final String action,
        ...
        else if (UUID_BODY_TEMP_MEASUREMENT.equals(characteristic.getUuid())) {
            byte num[] = characteristic.getValue();
            Integer res = (num[5] *256 )+ (num[4]); // + num[7];
            Float temp  = ((float) (res - 0xe1e ) * (float) 0.005) + (float) 36.6 ;// e1e-> 36.6 , e1b-> 36.4
